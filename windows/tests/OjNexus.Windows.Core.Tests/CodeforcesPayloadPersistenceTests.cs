...
{
    [Fact]
    public void FreshDatabase_UsesSchemaVersionTwoAndCreatesPayloadTables()
    {
        ...
        Assert.Equal("2", command.ExecuteScalar()?.ToString());
        Assert.Equal(
            new[] { "accounts", "codeforces_profiles", "codeforces_ratings", "codeforces_submissions", "schema_metadata", "sync_modules", "sync_operations" },
